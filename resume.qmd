...
##
Michael Kelleman is a Senior Statistician II with over a decade of combined academic and industry experience, specializing in real-world evidence, clinical research, and advanced statistical methodologies. He brings extensive expertise in R, SAS, SQL, and CDISC standards, applying robust analytical techniques across cardiology, emergency medicine, nephrology, and autoimmune disease research. Michael has led large multicentre projects, authored numerous scientific publications, and consistently delivers high-quality, reproducible statistical solutions.
...
```{r}
exp_school(employer = "Emory University, Rollins School of Public Health",
           desc = c("MSPH, Biostatistics"),
           date = "2011 – 2013")
```

```{r}
exp_school(employer = "Columbia University, School of Physicians and Surgeons",
           desc = c("MS, Nutrition and Public Health"),
           date = "2007 – 2008")
```

```{r}
exp_school(employer = "Franklin and Marshall College",
           desc = c("AB, Mathematics"),
           date = "2003 – 2007")
```
